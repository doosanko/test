...
<div class="Gradient">
      ...
      <header class="MainHeaderBar sticky">
         <div class="icon">   
            <h2>
               <a class="logo" href="../../">KOREAN&nbsp;HISTORY</a>
            </h2>
         </div>
         <nav class="TopMenu">
            <ul>
               ...
               <li class="topmenuLink">
                  <a class="menuLink" href="#">History</a>   
                     <ul class="subMenu">
                        <li><a class="submenuLink longLink" href="../wiki_view/k_im">독립운동      </a></li>
                        <li><a class="submenuLink longLink" href="../wiki_view/dokdo">독도         </a></li>
                        <li><a class="submenuLink longLink" href="../wiki_view/slave">위안부         </a></li>
                        <li><a class="submenuLink longLink" href="../wiki_view/ktw">한일 관계      </a></li>
                        <li><a class="submenuLink longLink" href="../wiki_view/eastsea">동해         </a></li>
                     </ul>
               </li>
               <li class="topmenuLink">
